...
<style type="text/css">
    ...
    input[type="submit"]:hover{
       ...
       <?php 
include 'card_table_process.php';
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Cards</strong>
                                    ...
                                    <tbody>
                                       <?php
                                          while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
                                           echo "<tr><td>" . $row['cardid'] . "</td><td>" . $row['fname'] . "</td><td>" . $row['city'] . "</td><td>" . $row['type'] . "</td><td>" . $row['income'] ."<form action='card_table_process.php' method='post'><input type='text' name='gmail' value='".$row['gmail']."' hidden><input type='submit' name='submit' value='View'></form>". "</td></tr>";//$row['index'] the index here is a field name
                                          }
