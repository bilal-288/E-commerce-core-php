...
$status="accept";
$query = "SELECT *, card.id AS cardid FROM card  INNER JOIN card_type ON card.card_typeid=card_type.id WHERE  card.status='$status'";//You don't need a ; like you do in SQL
