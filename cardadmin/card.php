...
<link rel="stylesheet" href="https://opensource.keycdn.com/fontawesome/4.6.3/font-awesome.min.css"
    ...
    <div class="page-heading"><h4 style="padding-left:20px; color:#FF8500;">Card View</h4></div>
                ...
                <div class="tabbable-line">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_default_1">
                            ...
                            <form action="card_process.php" method="POST">
                                <input type="text" name="gmail" value="<?php echo $gmail  ?>" hidden="on">
                                
                                <p align="center" style="float: center; padding:20px;">
                                    <button type="submit" name="remake" class="decline btn btn-default btn-sm">
                                    <i class="fa fa-envelope "> </i>  send gmail for remake card</button>
                                </p>
                            </form>
                        </div>
