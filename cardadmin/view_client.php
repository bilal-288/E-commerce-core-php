...
include 'header.php';
?>
<?php include 'view_client_process.php' ?>
...
<link rel="stylesheet" href="https://opensource.keycdn.com/fontawesome/4.6.3/font-awesome.min.css"
    ...
    <div class="page-heading"><h4 style="padding-left:20px; color:#FF8500;">View Client</h4></div>
            ...
            <div class="col-md-5 col-sm-5 col-xs-12">
                ...
                <ul>
                    ...
                    <li><span class="glyphicon glyphicon-envelope"></span><a href="#" title="mail"><?php echo $profilegmail?></a></li>
                     <li><form action="view_client_process.php" method="POST">
                                <input type="text" name="btnid" value="<?php echo $profileid  ?>" hidden="on">
                                
                                <p align="right" style="float: left; padding:20px;">
                                    <button style="background-color: red; font-size:15px; color:white;" type="submit" name="block" class="decline btn btn-default btn-sm">
                                    <span class="glyphicon glyphicon-trash"></span> Block</button>
                                </p>
                            </form></li>
                </ul>
            </div>
