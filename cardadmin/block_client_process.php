...
include 'connection.php';
    ...
    $discount=$data['discount'];
      ...
      $edit="pending";   
          ...
          $query1="UPDATE card SET status='$edit' WHERE profileid='$id'";
...
if($result && $result1)
    {
      ...
      header("location: block_client_table.php?message=user active");
}
else{
    header("location: block_client_table.php?message=error occurred user not unblock try again!");
}
