         ...
         <?php
          $count=0;
              ...
              while($row = mysqli_fetch_array($result)){   
                ...
                $categoryid= $row['id'];  
                $after_discount=$row['price'] * ( (100-$row['price']) / 100 );   
                echo "<div class='col'>
                       <div class='item as' style=' border-color: orange;'>
                          <p class='productheading' style='font-size:30px; font-weight:bold;'>".$row['name']."</p>"."<p style='font-size:13px;font-weight:bold;'>&nbsp;&nbsp;&nbsp;&nbsp;Price: ".$row['price']." rs.<br><b>Discounts</b>";
                $productid=$row['id'];
                $query6="SELECT * FROM discount INNER JOIN card_type ON card_type.id=discount.card_typeid WHERE productid='$productid'";
                $result6=mysqli_query($con, $query6);
                while ($row1=mysqli_fetch_assoc($result6)) {
                    echo "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$row1['type'].": ". $row1['discount']."%("."rs)";
                }
