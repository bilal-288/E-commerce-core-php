...
?>
<?php include 'card_reject_process.php' ?>
...
<div class="page-heading"><h4 style="padding-left:20px; color:#FF8500;">Card Reject View</h4></div>
            ...
            <div class="tabbable-line">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_default_1">
                        <form action="card_reject_process.php" method="POST">
