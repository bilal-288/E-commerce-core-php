...
<style type="text/css">
    ...
    input[type="submit"]:hover{
       ...
       <?php 
include 'update_shop_table_process.php';
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Update Shops</strong>
                                    ...
                                    <tbody> 
                                       ...
                                       $count=1;
                                          while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
                                           echo "<tr><td>" . $count . "</td><td>" . $row['username'] . "</td><td>" . $row['shopname'] . "</td><td>" . $row['gmail'] . "</td><td>" . $row['address'] ."<form action='update_shop_table_process.php' method='post'><input type='text' name='gmail' value='".$row['gmail']."' hidden><input type='submit' name='submit' value='Edit'></form>". "</td></tr>";//$row['index'] the index here is a field name
                                            $count++;
                                          }
