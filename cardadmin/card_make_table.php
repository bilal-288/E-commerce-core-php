...
<!-- Header-->
<?php
include 'card_make_table_process.php';
?>
<div class="content">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Card Make</strong>
                    ...
                    <div class="card-body">
                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                echo "<tr><td>" . $row['cardid'] . "</td><td>" . $row['fname'] . "</td><td>" . $row['city'] . "</td><td>" . $row['type'] . "</td><td>" . $row['income'] ."<form action='card_make_table_process.php' method='post'><input type='text' name='gmail' value='".$row['gmail']."' hidden><input type='submit' name='submit' value='Make'></form>". "</td></tr>";//$row['index'] the index here is a field name
                                }
                                ?>
                            </tbody>
