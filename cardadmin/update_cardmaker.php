...
$query="SELECT * FROM card_shop WHERE gmail='$shopgmail'";
...
<div class="page-heading"><center><h3 style="padding-left:20px; color:#FF8500;">edit cardmaker shop</h3></center></div>

<div class="form-style-2">
<div  style="padding-top: 30px;"class="form-style-2-heading">edit cardmaker Shop information</div>
<p style="color: red; text-align: center;"><?php echo @$_GET['message']; ?></p>
<form name="msform" action="update_cardmaker_process.php" method="post">
...
<label for="field1"><span>Gmail </span><input type="text" class="input-field" id="gmail" name="gmail" onfocusout="checkgmail()" value="<?php echo $data['gmail']; ?>"/></label>
...
<input type="text" name="id" value="<?php echo $data['id'] ?>" hidden="on">
