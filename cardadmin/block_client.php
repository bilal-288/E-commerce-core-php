...
include 'header.php';
?>
<?php include 'block_client_process.php' ?>
...
<link rel="stylesheet" href="https://opensource.keycdn.com/fontawesome/4.6.3/font-awesome.min.css"
    ...
    <div class="page-heading"><h4 style="padding-left:20px; color:#FF8500;">Bloked Client</h4></div>
            ...
            <div class="col-md-5 col-sm-5 col-xs-12">
                ...
                <ul>
                    ...
                    <li><span class="glyphicon glyphicon-envelope"></span><a href="#" title="mail"><?php echo $profilegmail?></a></li>
                     <li><form action="block_client_process.php" method="POST">
                                <input type="text" name="btnid" value="<?php echo $profileid  ?>" hidden="on">
                                
                                <p align="right" style="float: left; padding:20px;">
                                    <button style="background-color: #3CB371; font-size:15px; color:white;" type="submit" name="unblock" class="decline btn btn-default btn-sm">
                                    <span class="glyphicon glyphicon-repeat"></span> Unblock</button>
                                </p>
                            </form></li>
                </ul>
            </div>
            ...
            <div data-spy="scroll" class="tabbable-panel">
                <div class="tabbable-line">
                    <ul class="nav nav-tabs ">
                        <li class="active">
                            <a href="#tab_default_1" data-toggle="tab">Card #:  <?php echo $id ?></a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane active" id="tab_default_1">
                            ...
                            <div class="well well-sm">
                                <h4>Card Status: 
                                    <?php
                                    if($id=""){
                                    echo "card request not send by client yet";
                                    }else{
                                    echo $status;
                                    }
                                    ?>
                            ...
                            <table class="table bio-table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="2"><strong>Card Category:</strong>  <?php echo $type ?></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"><strong style="font-weight: bold;">Request time: </strong> <span style="color: skyblue;"> <?php echo $date ?></span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
        ...
        <div class="col-sm-3">
            ...
            <div class="panel panel-default">
                <div class="menu_title">
                    ...
                    <p><strong>Category:</strong>  <?php echo $type ?></p>
                </div>
