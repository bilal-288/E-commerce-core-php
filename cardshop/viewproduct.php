       ...
       <?php 
include 'viewproduct_process.php';
                    ...
                    <div class="col-md-12">
                        <div class="card" >
                            <div class="card-header">
                                <strong class="card-title" style="color: #FF8500;">Products</strong>
                                   <div class="content">
                                          <form action="viewproduct_process.php" method="post"><input type="number" name="cardid">
