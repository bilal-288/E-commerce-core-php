                                    ...
                                    <tbody>
                                       <?php
                                          while($row = mysqli_fetch_array($result)){   
                                           ...
                                           echo "<tr><td>" . $row['id'] . "</td><td>" . $row['fname'] . "</td><td>" . $row['city'] . "</td><td>" . $row['category'] . "</td><td>" . $row['income'] ."<form action='card_request_table_process.php' method='post'><input type='text' name='gmail' value='".$row['gmail']."' hidden><input type='submit' name='submit' value='View'></form>". "</td></tr>";
