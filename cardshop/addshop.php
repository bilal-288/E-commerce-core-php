...
<label for="field1"><span>Product Name <span class="required">*</span></span><input type="text" class="input-field" name="shopname" value="" / required></label>
<input type="number" min="0.00" max="10000.00" step="0.01" />

<label for="field1"><span>Password <span class="required">*</span></span><input type="password" class="input-field" name="password" value="" onfocusout="checkpassword()"/></label>

<label for="field2"><span>Conform Password <span class="required">*</span></span><input type="password" class="input-field" name="conformpassword" value="" onfocusout="checkconformpassword()"/></label>
...
<label><button name="submit" style="margin-left: 35%;"><i class="menu-icon fa fa-cart-plus" style="font-size: 20px;"></i>  ADD Shop</button></label>
<br>
<br>
</form>
</div>
